...
declare global {
  interface Array<T> {
    toDtos<T extends AbstractEntity<Dto>, Dto extends AbstractDto>(this: T[], options?: any): Dto[];
...
Array.prototype.toDtos = function <T extends AbstractEntity<Dto>, Dto extends AbstractDto>(
  options?: any,
): Dto[] {
...
SelectQueryBuilder.prototype.paginate = async function (pageOptionsDto: PageOptionsDto) {
